            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                <div className="space-y-2">
                    ...
                    <p className="text-muted-foreground font-medium max-w-2xl pl-1">
                        Orchestrate and manage architectural data flows stored in <code className="px-1.5 py-0.5 rounded bg-muted text-foreground text-xs font-bold">./artifacts/workflows</code>.
                    </p>
                </div>
